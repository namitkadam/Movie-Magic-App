export default function List({ name, icon, wrapperClass, liClassName }) {
  return (
    <>
      ...
      >
        <div
          className={`inline-flex items-center gap-x-0.5 text-[10px] font-semibold text-gray-400  hover:text-[#263238] max-lg:hover:text-white focus:first:rounded-2xl first:mt-0  ${liClassName}`}
        >
